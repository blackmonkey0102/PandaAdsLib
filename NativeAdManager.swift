...
public class NativeAdManager: NSObject {
    ...
    public func loadNativeAd(
            ...
            if !canShowAds || MySettings.isRemoveAds(){
                Helpers.myLog(text: "Native config false, of remove ads")
    ...
    extension NativeAdManager: GADNativeAdLoaderDelegate {
        public func adLoader(_ adLoader: GADAdLoader, didReceive nativeAd: GADNativeAd) {
            Helpers.myLog(text: "Native ad did load: \(adLoader.adUnitID ?? "Unknown ID")")
        ...
        public func adLoader(_ adLoader: GADAdLoader, didFailToReceiveAdWithError error: Error) {
            Helpers.myLog(text: "Native ad failed to load: \(error.localizedDescription)")

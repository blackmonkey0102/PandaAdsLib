...
public class BannerAdManager: NSObject {
    ...
    public func loadBannerAd(
            ...
            if !canShowAds || !MyHelpers.isConnectionInternet(){
                MyHelpers.myLog(text: "Banner config false, or remove ads, or no internet")
            ...
            MyHelpers.myLog(text: "Banner adUnitNameRequest = \(adUnitNameRequest) - isShowingBanner = \(isShowingBanner) - stateLoadBanner = \(stateLoadBanner) - title: \(String(describing: type(of: viewController)))")
    ...
    extension BannerAdManager: GADBannerViewDelegate {
        ...
        public func bannerViewDidRecordImpression(_ bannerView: GADBannerView) {
            MyHelpers.myLog(text: "Banner ad recorded impression")
            
        }
        
        public func bannerViewWillPresentScreen(_ bannerView: GADBannerView) {
            MyHelpers.myLog(text: "Banner ad will present screen")
        }
        
        public func bannerViewWillDismissScreen(_ bannerView: GADBannerView) {
            MyHelpers.myLog(text: "Banner ad will dismiss screen")
        }
        
        public func bannerViewDidDismissScreen(_ bannerView: GADBannerView) {
            MyHelpers.myLog(text: "Banner ad did dismiss screen")
        }
    }
